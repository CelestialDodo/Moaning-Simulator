...
function enableButton() {
    canClick = true; document.getElementById("clickButton").style.borderColor = "rgb(138, 43, 226)"; document.getElementById("clickButton").removeAttribute("disabled");
}
...
if (typeof(Storage) !== "undefined") {
    ...
    document.getElementById("clickButton").addEventListener("click", function() {
        if (canClick) {
            ...
            document.getElementById("clickButton").style.borderColor = "rgb(118, 0, 189)";
